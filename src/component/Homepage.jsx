    ...
    return (
        <>
            ...
            <section className='relative'>
                <img src='/foodie.png' alt="banner_image" className='bg-cover w-full' />
                <header className='absolute top-[200px] left-[690px] text-center'>

                    {/* --------- Header --------- */}
                    <h1 className='font-PlayfairD text-[100px] font-normal leading-[96px] '>Yummy food for <br /> your taste</h1>
                    <p className='mt-8 font-DM_sans text-xl font-normal'>Explore delicious cuisine and unforgettable tastes <br /> in our culinary haven.</p>

                    {/* --------- Booking part --------- */}
                    <button className='mt-10 flex gap-4 ml-[100px] text-[#182226] text-base font-DM_sans font-bold'>
                        <Link to = "/book"><button className='px-8 py-5 border-2 border-[#e1e0dd] rounded-full hover:bg-[#9b3f6272] hover:text-white hover:border-[#AD343E] transition duration-200'>Book A Table</button></Link>
                        <Link to = "/manu"><button className='px-8 py-5 border-2 border-[#e1e0dd] rounded-full hover:bg-[#3f9b9b72] hover:text-white hover:border-[#AD343E] transition duration-200'>Explore Manu</button></Link> 
                    </button>
                </header>
            </section>
            ...
            <section className='py-[120px] container'>
                ...
                <ul className='mt-16 flex justify-between'>
                    ...
                    {/* --------- Birthday Part --------- */}
                    <ul className='flex flex-col justify-start gap-6 w-[306px] hover:scale-105 duration-300 will-change-transform'>
                        <li><img src='/birthday.png' alt="service2_image" height="70" /></li>
                ...
                <div className='mt-16 flex justify-between '>
                    ...
                    <ul className='w-[416px] p-[35px] flex flex-col bg-[#F9F9F7] gap-8 hover:shadow-[inset_5px_5px_20px_rgba(0,0,0,0.2)] rounded-2xl'>
                        ...
                        <ul className='flex gap-5'>
                            ...
                            <ul className='flex flex-col justify-center gap-1'>
                                <li className='font-DM_sans font-bold text-base'>Natasha</li>
                                <li className='font-DM_sans font-normal text-base'>Manhattan, California</li>
                            </ul>
                        </ul>   
                    </ul>
                    ...
                    <ul className='w-[416px] p-[35px] flex flex-col bg-[#F9F9F7] gap-8 hover:shadow-[inset_5px_5px_20px_rgba(0,0,0,0.2)] rounded-2xl'>
                        ...
                        <ul className='flex gap-5'>
                            ...
                            <ul className='flex flex-col justify-center gap-1'>
                                <li className='font-DM_sans font-bold text-base'>Kalix</li>
                                <li className='font-DM_sans font-normal text-base'>San, CA</li>
                            </ul>
                        </ul>   
                    </ul>
                    ...
                    <ul className='w-[416px] p-[35px] flex flex-col bg-[#F9F9F7] gap-8 hover:shadow-[inset_5px_5px_20px_rgba(0,0,0,0.2)] rounded-2xl'>
                        ...
                        <ul className='flex gap-5'>
                            ...
                            <ul className='flex flex-col justify-center gap-1'>
                                <li className='font-DM_sans font-bold text-base'>Sevi</li>
                                <li className='font-DM_sans font-normal text-base'>San, LA</li>
                            </ul>
                        </ul>   
                    </ul>
                </div>
