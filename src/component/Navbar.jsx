                ...
                <header className='py-2 bg-[#474747]'>
                    <ul className='container flex justify-between'>
                        <ul className='flex gap-6 text-white font-DM_sans text-base font-normal'>
                            <li className='flex items-center gap-1'><FaPhone /> 9848567678</li>
                            <li className='flex items-center gap-1'><IoIosMail /> tasty@bitebuzz</li>
                        </ul>
                ...
                <main className='py-4 border-b-2 bg-[#F9F9F7]'>
                    <ul className='container flex justify-between'>
                        ...
                        <Link to = "/" className='flex gap-4 items-center '>
                            ...
                            <h1 className='font-PlayfairD font-semibold text-[42px] italic text-[#474747] '>Bite Buzz</h1>
                        </Link>
                        ...
                        <ul className='flex items-center gap-8 text-[#2C2F24] font-DM_sans font-medium text-base'>
                            ...
                            <Link to = "/manu"    className='py-1 px-4 hover:bg-[#DBDFD0] transition duration-400 rounded-2xl'>Menu</Link>
