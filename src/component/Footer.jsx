    ...
    return (
        <>
            ...
            <footer className='mt-[125px] w-full bg-[#474747] px-[150px] pt-[120px] pb-[55px]'>
                <ul className=' flex justify-between'>
                    <ul className='flex flex-col gap-[30px] text-white'>
                        ...
                        <Link to = '/' className='flex items-center '>
                            ...
                            <h3 className='ml-3 font-PlayfairD font-semibold text-[33px] italic leading-[30px]'>Bite Buzz</h3>
                        </Link>

                        {/* ------- Footer Info ------- */}
                        <li>
                            In the new era of technology we look a <br /> in the future with certainty and pride to <br /> for our webpage and.
                        </li>
                    ...
                    <ul className='text-white'>
                        ...
                        <li className=' flex flex-col gap-5 font-DM_sans font-normal text-base mt-10 '>
                            ...
                            <Link to = "/manu" className='hover:text-red-400'>Menu</Link>
                ...
                {/* ================= Copy-Right Part ================= */}
                <p className='mt-[130px] text-[#ADB29E] text-base font-DM_sans font-normal text-center'>Copyright © 2023 Hashtag Ammuleshwari. All Rights Reserved</p>  
            </footer>
        </>
    )
}
