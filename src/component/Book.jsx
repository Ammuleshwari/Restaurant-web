            ...
            <section >
                ...
                <form onSubmit={handleSubmit} className='w-[800px] container p-10 mt-[72px] shadow-2xl rounded-2xl'>
                    <ul className='flex gap-6 flex-col'>
                        ...
                        {/* for send button */}
                        <ul>
                            <button className='w-full py-5 bg-[#5b1a81] text-white rounded-full font-DM_sans font-bold text-base hover:bg-purple-500 active:scale-95 duration-200'>Send</button>
                        </ul>
                    </ul>
                </form>
            </section>
